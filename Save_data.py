...
error1 = np.array([12.52-9.8, -0.35, -0.90])
error2 = np.array([10.40-9.8, 0.10, -1.91])
error3 = np.array([9.91-9.8, 0.30, -0.39])
error4 = np.array([9.45-9.8, -0.84, -0.95])
error5 = np.array([15.34-9.8, 2.01, 0.76])
...
def move_arrow(root, direction1, direction2, direction3, direction4, direction5,
    ...
    print("Root angle: ", ang1,
          ...
          ",Ang 3/4:", ang4,
          ",Ang 4/5:", ang5)
    ang_row = [ang1, ang2, ang3, ang4, ang5]
